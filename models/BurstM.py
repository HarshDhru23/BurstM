...
class Neural_Warping_Grayscale(nn.Module):
    """
    Modified Neural_Warping for grayscale (1-channel) input.
    Adapts the encoder to work with single-channel images instead of 4-channel RAW.
    """
    def __init__(self, encoder_spec='edsr-baseline', blender_spec='edsr-baseline', hidden_dim=128):
        super().__init__()
